...
// glew is not part of the glitter demo, so it is not part of the xcode glitter project that cmake built for me.
// "glad" IS part of the glitter project, so including glad instead of glew was enough to make the learnopengl.com sample inside the xcode glitter framework.

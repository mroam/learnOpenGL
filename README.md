...
Helpful Links
------------
* http://openglbook.com for *openGL 4* (see preface for hardware and software requirements, and explanation that old  “glBegin, glEnd, glVertex3f, and glColor3f ... are not present in the OpenGL 4.0 Core Profile. Forget everything that you've learned about (old) immediate mode OpenGL ... since it is never coming back.”)
